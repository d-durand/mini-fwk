<?php /*%%SmartyHeaderCode:131699509250b47fda632d61-00436944%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '131699509250b47fda632d61-00436944',
  'variables' => 
  array (
    'titre' => 0,
    'Bloc_Login' => 0,
  ...
  'unifunc' => 'content_50b47fda6b873',
  'cache_lifetime' => 3600,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_50b47fda6b873')) {function content_50b47fda6b873($_smarty_tpl) {?><!-- start template-->
<html>
	<head>
	<title>Doc</title>
	...
	<input type='submit' value='Login'>
		...
		<div id='menu'>
			<a href='?' title='contenu'>Defaut</a> Exemples &rarr; 
						<a href='?module=SimpleTemplate'>SimpleTPL</a>
						<a href='?module=Formulaire'>Formulaire</a>
						<a href='?module=Redirect'>Redirect</a>
						<a href='?module=DownloadFile'>Download</a>
						<a href='?module=Ajax'>Ajax</a>
						<a href='?module=Doc'>Doc</a>
					</div>
		...
		<div id='contenu'>
			Zone d'affichage du contenu généré par le module <b>Doc->index()</b>
...
<h5>Méthodes</h5>
<p>Chacune des méthodes suivantes ajoute un élément et renvoie un objet <tt>HTMLInput</tt>, mequem peut être utilisé pour définir une valeur par défaut avec la méthode <tt>set_value</tt></p>
<ul>
...
<li><tt>populate()</tt> : remplit les champs du formulaire avec les paramètres passés dans la requête HTTP</li>
</ul>
<h5>Remarque</h5>
<p>
